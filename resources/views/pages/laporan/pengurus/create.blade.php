    ...
    <div class="container-xxl flex-grow-1 ">
        ...
        <div class="card">
            ...
            <div class="card-body mt-0 pt-0">
                <form id="form" class="mb-3" action="{{ route('laporan-pengurus.store') }}"
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="tempat_kegiatan" name="tempat_kegiatan"
                            placeholder="Masukkan tempat kegiatan" autofocus value="{{ old('tempat_kegiatan') }}" />
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="jumlah_peserta" name="jumlah_peserta"
                            placeholder="Masukkan jumlah peserta" autofocus value="{{ old('jumlah_peserta') }}" />
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="evaluasi_kegiatan" name="evaluasi_kegiatan" placeholder="Tuliskan evaluasi kegiatan"
                            autofocus>{{ old('evaluasi_kegiatan') }}</textarea>
