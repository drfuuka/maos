...
@section('title', 'Laporan Pengurus - Ubah')
    ...
    <div class="container-xxl flex-grow-1 ">
        ...
        <div class="card">
            <div class="d-flex justify-content-between align-items-center">
                <h5 class="card-header">Ubah Laporan Pengurus</h5>
            ...
            <div class="card-body mt-0 pt-0">
                <form id="form" class="mb-3" action="{{ route('laporan-pengurus.update', $laporanGudep->id) }}"
